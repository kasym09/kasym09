...
Всем привет я могу предобрабатывать данные, проводить исследовательский анализ, строить/тренить модели МЛ для табличных данных, так же немного знаю Keras / Tensorflow. Умею строить дэшборды в Power BI, селектить в SQL(функции агрегации, оконные функции, подзапросы). Еще знаю Git и основы GO.
